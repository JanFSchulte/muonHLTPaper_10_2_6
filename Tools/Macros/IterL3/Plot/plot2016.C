...
gStyle->SetLabelSize(0.035, "XYZ");
	...
	TFile *f=new TFile("bla_efficiency_prefilter.root","READ");
/*
...
latex->DrawLatex(0.95, 0.96, "1.3 fb^{-1} (2016) (13 TeV)");
...
latexCMSExtra->DrawLatex(0.275,0.955,"Preliminary");
 ...
 gPad->RedrawAxis();
 c1->SaveAs("CascadeTkMuEffvsPt.pdf");
 c1->SaveAs("CascadeTkMuEffvsPt.png");
...
c2->SaveAs("CascadeTkMuEffvsEta.pdf");
 c2->SaveAs("CascadeTkMuEffvsEta.png");
...
c3->SaveAs("CascadeTkMuEffvsPhi.pdf");
 c3->SaveAs("CascadeTkMuEffvsPhi.png");
...
gPad->RedrawAxis();
 c4->SaveAs("CascadeTkMuEffvsnVtx.pdf");
 c4->SaveAs("CascadeTkMuEffvsnVtx.png");
