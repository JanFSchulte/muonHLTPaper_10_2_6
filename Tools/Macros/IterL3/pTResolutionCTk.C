...
void pTResolutionCTk(TString inputfilename="/eos/uscms/store/user/bmahakud/ProductionHLTAN_LPC_IterL3HighStat/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/ProductionHLTAN_LPC_IterL3HighStat/181130_193653/0000/muonNtupleIterL3.root", std::string effmeasured="MC2018"){
  ...
  TH1F* pTChargeAllL3Tk =new TH1F("pTChargeAllL3Tk","pTChargeAllL3Tk",19,  pt_bins );
  TH1F* pTChargeMisL3Tk =new TH1F("pTChargeMisL3Tk","pTChargeMisL3Tk",19,  pt_bins );
  ...
  TH1F* etaChargeAllL3Tk =new TH1F("etaChargeAllL3Tk","etaChargeAllL3Tk",15,  eta_bins );
  TH1F* etaChargeMisL3Tk =new TH1F("etaChargeMisL3Tk","etaChargeMisL3Tk",15,  eta_bins );
  ...
  TH1F* pTChargeAllGenL3Tk =new TH1F("pTChargeAllGenL3Tk","pTChargeAllGenL3Tk",19,  pt_bins );
  TH1F* pTChargeMisGenL3Tk =new TH1F("pTChargeMisGenL3Tk","pTChargeMisGenL3Tk",19,  pt_bins );
  ...
  TH1F* etaChargeAllGenL3Tk =new TH1F("etaChargeAllGenL3Tk","etaChargeAllGenL3Tk",15,  eta_bins );
  TH1F* etaChargeMisGenL3Tk =new TH1F("etaChargeMisGenL3Tk","etaChargeMisGenL3Tk",15,  eta_bins );
  ...
  TH2F* ptResVsPtL3 = new TH2F("ptResVsPtL3","ptResVsPtL3",1000,-5,5,100,0,1000);
  TH2F* ptResVsEtaL3 = new TH2F("ptResVsEtaL3","ptResVsEtaL3",1000,-5,5,100,-2.4,2.4);

  TH1F* ptResL3Tk=new TH1F("ptResL3Tk","ptResL3Tk",1000,-5,5 );
  TH2F* ptResVsPtL3Tk = new TH2F("ptResVsPtL3Tk","ptResVsPtL3Tk",1000,-5,5,100,0,1000);
  TH2F* ptResVsEtaL3Tk = new TH2F("ptResVsEtaL3Tk","ptResVsEtaL3Tk",1000,-5,5,100,-2.4,2.4);
  ...
  TH1F* ptResL3InvTk=new TH1F("ptResL3InvTk","ptResL3InvTk",1000,-5,5 );
  TH2F* ptResVsPtL3InvTk = new TH2F("ptResVsPtL3InvTk","ptResVsPtL3InvTk",1000,-2.5,2.5,100,0,1000);
  TH2F* ptResVsEtaL3InvTk = new TH2F("ptResVsEtaL3InvTk","ptResVsEtaL3InvTk",1000,-2.5,2.5,100,-2.4,2.4);
  ...
  TH1F* ptResL3QPtTk=new TH1F("ptResL3QPtTk","ptResL3QPtTk",1000,-5,5 );
  TH2F* ptResVsPtL3QPtTk = new TH2F("ptResVsPtL3QPtTk","ptResVsPtL3QPtTk",1000,-2.5,2.5,100,0,1000);
  TH2F* ptResVsEtaL3QPtTk = new TH2F("ptResVsEtaL3QPtTk","ptResVsEtaL3QPtTk",1000,-2.5,2.5,100,-2.4,2.4);




  TH1F* ptResL1Gen=new TH1F("ptResL1Gen","ptResL1Gen",1000,-5,5 );
  TH2F* ptResVsPtL1Gen = new TH2F("ptResVsPtL1Gen","ptResVsPtL1Gen",1000,-5,5,100,0,1000);
  ...
  TH2F* ptResVsPtL3Gen = new TH2F("ptResVsPtL3Gen","ptResVsPtL3Gen",1000,-5,5,100,0,1000);
  TH2F* ptResVsEtaL3Gen = new TH2F("ptResVsEtaL3Gen","ptResVsEtaL3Gen",1000,-5,5,100,-2.4,2.4);

  TH1F* ptResL3TkGen=new TH1F("ptResL3TkGen","ptResL3TkGen",1000,-5,5 );
  TH2F* ptResVsPtL3TkGen = new TH2F("ptResVsPtL3TkGen","ptResVsPtL3TkGen",1000,-5,5,100,0,1000);
  TH2F* ptResVsEtaL3TkGen = new TH2F("ptResVsEtaL3TkGen","ptResVsEtaL3TkGen",1000,-5,5,100,-2.4,2.4);
  ...
  TH1F* ptResL3InvTkGen=new TH1F("ptResL3InvTkGen","ptResL3InvTkGen",1000,-5,5 );
  TH2F* ptResVsPtL3InvTkGen = new TH2F("ptResVsPtL3InvTkGen","ptResVsPtL3InvTkGen",1000,-2.5,2.5,100,0,1000);
  TH2F* ptResVsEtaL3InvTkGen = new TH2F("ptResVsEtaL3InvTkGen","ptResVsEtaL3InvTkGen",1000,-2.5,2.5,100,-2.4,2.4);
  ...
  TH1F* ptResL3QPtTkGen=new TH1F("ptResL3QPtTkGen","ptResL3QPtTkGen",1000,-5,5 );
  TH2F* ptResVsPtL3QPtTkGen = new TH2F("ptResVsPtL3QPtTkGen","ptResVsPtL3QPtTkGen",1000,-2.5,2.5,100,0,1000);
  TH2F* ptResVsEtaL3QPtTkGen = new TH2F("ptResVsEtaL3QPtTkGen","ptResVsEtaL3QPtTkGen",1000,-2.5,2.5,100,-2.4,2.4);
...
//  int nentries = 10000000;// tree->GetEntries();
  ...
  for (Int_t eventNo=0; eventNo < nentries; eventNo++)     {
	...
	if (match){
		if (ev -> muons.at(jmu).charge !=  ev -> muons.at(jmu).charge) std::cout << ev -> muons.at(jmu).charge << " " << closestL3.charge << std::endl;
	...
	match = false;
        minDR = 0.1;
        theDR = 100;
	HLTMuonCand closestL3Tk;
        for ( std::vector<HLTMuonCand>::const_iterator it = ev -> tkmuons.begin(); it != ev -> tkmuons.end(); ++it ) {
    		theDR = deltaR(it -> eta, it -> phi, ev -> muons.at(jmu).eta,ev -> muons.at(jmu).phi);
   		 if (theDR < minDR){
      			minDR = theDR;
      			match = true;	
	...
	if (match){
		double ptResL3InvVal = (1./ ev -> muons.at(jmu).pt - 1. / closestL3Tk.pt ) / (1./ev -> muons.at(jmu).pt);
		double ptResL3QPtVal = (ev -> muons.at(jmu).charge/ ev -> muons.at(jmu).pt - closestL3Tk.charge / closestL3Tk.pt ) / (ev -> muons.at(jmu).charge / ev -> muons.at(jmu).pt);
		double ptResL3Val = (ev -> muons.at(jmu).pt - closestL3Tk.pt ) / ev -> muons.at(jmu).pt;
		ptResL3InvTk->Fill(ptResL3InvVal);
		ptResL3QPtTk->Fill(ptResL3QPtVal);
		ptResL3Tk->Fill(ptResL3Val);
		ptResVsPtL3InvTk->Fill(ptResL3InvVal,ev -> muons.at(jmu).pt);
		ptResVsPtL3QPtTk->Fill(ptResL3QPtVal,ev -> muons.at(jmu).pt);
		ptResVsPtL3Tk->Fill(ptResL3Val,ev -> muons.at(jmu).pt);
		ptResVsEtaL3InvTk->Fill(ptResL3InvVal,ev -> muons.at(jmu).eta);
		ptResVsEtaL3QPtTk->Fill(ptResL3QPtVal,ev -> muons.at(jmu).eta);
		ptResVsEtaL3Tk->Fill(ptResL3Val,ev -> muons.at(jmu).eta);

		pTChargeAllL3Tk->Fill(ev -> muons.at(jmu).pt);
		if (! (ev -> muons.at(jmu).charge == closestL3Tk.charge)) pTChargeMisL3Tk->Fill(ev -> muons.at(jmu).pt);
		etaChargeAllL3Tk->Fill(ev -> muons.at(jmu).eta);
		if (! (ev -> muons.at(jmu).charge == closestL3Tk.charge)) etaChargeMisL3Tk->Fill(ev -> muons.at(jmu).eta);
	...
	if (match){
      ...
      unsigned int nGenMuons = ev->genParticles.size(); 
	...
	if (match){
		double ptResL3InvVal = (1./ ev -> genParticles.at(jmu).pt - 1. / closestL3Tk.pt ) / (1./ev -> genParticles.at(jmu).pt);
		double ptResL3QPtVal = (getSign(ev -> genParticles.at(jmu).pdgId) / ev -> genParticles.at(jmu).pt - closestL3Tk.charge / closestL3Tk.pt ) / (getSign(ev -> genParticles.at(jmu).pdgId) / ev -> genParticles.at(jmu).pt);
		double ptResL3Val = (ev -> genParticles.at(jmu).pt - closestL3Tk.pt ) / ev -> genParticles.at(jmu).pt;
		ptResL3InvTkGen->Fill(ptResL3InvVal);
		ptResL3QPtTkGen->Fill(ptResL3QPtVal);
		ptResL3TkGen->Fill(ptResL3Val);
		ptResVsPtL3InvTkGen->Fill(ptResL3InvVal,ev -> genParticles.at(jmu).pt);
		ptResVsPtL3QPtTkGen->Fill(ptResL3QPtVal,ev -> genParticles.at(jmu).pt);
		ptResVsPtL3TkGen->Fill(ptResL3Val,ev -> genParticles.at(jmu).pt);
		ptResVsEtaL3InvTkGen->Fill(ptResL3InvVal,ev -> genParticles.at(jmu).eta);
		ptResVsEtaL3QPtTkGen->Fill(ptResL3QPtVal,ev -> genParticles.at(jmu).eta);
		ptResVsEtaL3TkGen->Fill(ptResL3Val,ev -> genParticles.at(jmu).eta);

		pTChargeAllGenL3Tk->Fill(ev -> genParticles.at(jmu).pt);
		if (! (getSign(ev -> genParticles.at(jmu).pdgId) == closestL3Tk.charge)) pTChargeMisGenL3Tk->Fill(ev -> genParticles.at(jmu).pt);
		etaChargeAllGenL3Tk->Fill(ev -> genParticles.at(jmu).eta);
		if (! (getSign(ev -> genParticles.at(jmu).pdgId) == closestL3Tk.charge)) etaChargeMisGenL3Tk->Fill(ev -> genParticles.at(jmu).eta);
 ...
 //Writing the histograms in a file.
  ...
  ptResL3InvTk->Write();
  ptResVsPtL3InvTk->Write();
  ptResVsEtaL3InvTk->Write();
  ...
  ptResL3QPtTk->Write();
  ptResVsPtL3QPtTk->Write();
  ptResVsEtaL3QPtTk->Write();
  ...
  ptResL3TkGen->Write();
  ptResVsPtL3TkGen->Write();
  ptResVsEtaL3TkGen->Write();
  ...
  ptResL3InvTkGen->Write();
  ptResVsPtL3InvTkGen->Write();
  ptResVsEtaL3InvTkGen->Write();
  ...
  ptResL3QPtTkGen->Write();
  ptResVsPtL3QPtTkGen->Write();
  ptResVsEtaL3QPtTkGen->Write();
  ...
  pTChargeAllL3->Write();
  pTChargeMisL3->Write();
  pTChargeAllL3Tk->Write();
  pTChargeMisL3Tk->Write();
  ...
  etaChargeAllL3Tk->Write();
  etaChargeMisL3Tk->Write();
  ...
  pTChargeAllGenL3Tk->Write();
  pTChargeMisGenL3Tk->Write();
  ...
  etaChargeAllGenL3Tk->Write();
  etaChargeMisGenL3Tk->Write();
